...
struct cached_allocator {
    ...
    void* allocate(std::ptrdiff_t num_bytes) {
        ...
        if (free_block != free_blocks.end()) {
            // std::cout << "cached_allocator::allocator(): found a hit" <<
            // std::endl;
            ...
            try {
                // std::cout << "cached_allocator::allocator(): no free block
                // found; calling cuda::malloc" << std::endl;
    ...
    void free_all() {
        ...
        for (free_blocks_type::iterator i = free_blocks.begin();
            ...
            thrust::system::cuda::free(
                thrust::system::cuda::pointer<void>(i->second));
        }
        ...
        for (allocated_blocks_type::iterator i = allocated_blocks.begin();
            ...
            // transform the pointer to cuda::pointer before calling cuda::free
            thrust::system::cuda::free(
                thrust::system::cuda::pointer<void>(i->first));
        }
    }
