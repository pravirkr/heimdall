...
void usage(char *binary, hd_params params) {
    ...
    cerr << "    -f0 f               centre frequency of highest channel "
            "[default "
         << params.f0 << "] MHz" << endl;
...
int main(int argc, char *argv[]) {
    ...
    const float *dm_list = dedisp_generate_dm_list_guru(
        params.dm_min, params.dm_max, params.dt, params.dm_pulse_width,
        params.f0, params.df, params.nchans, params.dm_tol, &dm_count);
