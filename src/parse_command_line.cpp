...
void hd_print_usage() {
    ...
    cout << "    -nsamps_gulp num         number of samples to be read at a "
            "time ["
         << p.nsamps_gulp << "]" << endl;
    cout << "    -baseline_length num     number of seconds over which to "
            "smooth the baseline ["
    ...
    cout << "    -coincidencer host:port  connect to the coincidencer on the "
         ...
         << endl;
    cout << "    -zap_chans start end     zap all channels between start and "
            "end channels inclusive"
         << endl;
    cout << "    -max_giant_rate nevents  limit the maximum number of "
            "individual detections per minute to nevents"
         << endl;
    cout << "    -dm_pulse_width num      expected intrinsic width of the "
            "pulse signal in microseconds"
         << endl;
    cout << "    -dm_nbits num            number of bits per sample in "
            "dedispersed time series ["
         << p.dm_nbits << "]" << endl;
    cout << "    -no_scrunching           don't use an adaptive time "
    ...
    cout << "    -boxcar_max num          maximum boxcar width in samples ["
         << p.boxcar_max << "]" << endl;
    cout << "    -fswap                   swap channel ordering for negative "
            "DM - SIGPROC 2,4 or 8 bit only"
         << endl;
